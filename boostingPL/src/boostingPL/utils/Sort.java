...
public class Sort {
	...
	public static void sort(Classifier[] classifiers, double[] orders) {
		quickSort(classifiers, orders, 0, classifiers.length-1);
	}
	
	private static void quickSort(Classifier[] classifiers, double[] orders, int left, int right) {
	...
	private static void swap(Classifier[] classifiers,  double[] orders, int i, int j) {
		Classifier tC;
		double t;
